...
<form style="text-align:center;"  method="post">
    Generate List By Application Semester: <select name="semesterSelection" required="required">
        ...
        $squery = "SELECT DISTINCT app_term FROM applicantion A, applicant B WHERE B.decision=1 OR B.decision=2 AND A.uid=B.uid";
...
<form style="text-align:center;"  method="post">
    Generate List By Application Year: <select name="yearSelection" required="required">
        ...
        $yquery = "SELECT DISTINCT app_year FROM applicantion A, applicant B WHERE B.decision=1 OR B.decision=2 AND A.uid=B.uid";
...
<form style="text-align:center;"  method="post">
    Generate List By Degree Program: <select name="majorSelection" required="required">
        ...
        $mquery = "SELECT DISTINCT area_of_interest FROM applicantion A, applicant B WHERE B.decision=1 OR B.decision=2 AND A.uid=B.uid";
